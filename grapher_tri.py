...
def dataset_one(data=["./dataset/dataset_tri.csv", "./dataset/dataset_tri_float.csv"], colls=None, maxx=80, xres=16, yres=6, color=None):
...
dataset_one(data=["./dataset/dataset_tri_S10F10.csv" ])
